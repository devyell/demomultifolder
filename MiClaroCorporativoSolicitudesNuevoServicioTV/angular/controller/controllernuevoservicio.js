...
appController.controller('ctrlNuevoServicioTv', ['$scope', '$http', '$timeout', 'srvNuevoServicioTv', '$httpParamSerializer',
    function($scope, $http, $timeout, srvNuevoServicioTv, $httpParamSerializer) {
        ...
        var pageIdNuevoServicio = WPSPageID.miclaro_corporativo_solicitudes_nuevoservicio_tv;
        ...
        $scope.urlInicio = '/wps/myportal/miclaro/corporativo/solicitudes/nuevoservicio/tv';
        var nombreLinea = '-';
        ...
        function init() {
            srvNuevoServicioTv.obtenerDatosUsuario().then(function(response) {
        ...
        $scope.solicitarNuevoServicio = function() {
            ...
            srvNuevoServicioTv.solicitarNuevoServicios(dataPlan).then(function(response) {
        ...
        function guardarAuditoria(rpta, idTransaccion, mensajeAuditoria) {
            ...
            srvNuevoServicioTv.guardarAuditoria(dataAuditoria).then(function(response) {}, function(error) {
