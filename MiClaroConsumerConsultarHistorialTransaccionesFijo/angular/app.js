...
app.config(function($routeProvider){
	...
	$routeProvider.when('/usuarioPrepagoView', {templateUrl: 'angular/view/usuarioPrepago.html'});
...
angular.element(document).ready(function() {
    angular.bootstrap(document.getElementById("consultarHistorialTransaccionesFijo"),['miClaroApp']);
});