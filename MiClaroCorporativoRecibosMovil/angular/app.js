...
app.config(function($routeProvider) {
    ...
    $routeProvider.when('/', { templateUrl: 'angular/view/consumer-recibos.html', controller: 'RecibosMovilController', controllerAs: 'recibosMovilCtr' });
    ...
    $routeProvider.when('/confirmacionErrorPagoPasarelaView', { templateUrl: 'angular/view/consumer-recibos-confirmacion-error-pasarela.html', controller: 'RecibosMovilController', controllerAs: 'recibosMovilCtr' });
