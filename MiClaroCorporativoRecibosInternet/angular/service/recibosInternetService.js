...
appServices.service('recibosInternetService', function($http) {
    ...
    var UrlObtenerServiciosPrincipalesFijos = comprasyRecargasUrl.obtenerServiciosPrincipalesFijos;
    var UrlobtenerDatosAdicionalesServicioFijoWSUrl = urlConsultasComun.obtenerDatosAdicionalesServicioFijo;
    ...
    this.getObtenerDatosAdicionalesFijoWS = function(request) {
        return $http.post(UrlobtenerDatosAdicionalesServicioFijoWSUrl, request);
    };
    ...
    this.obtenerServiciosPrincipalesFijos = function(request) {
        return $http.post(UrlObtenerServiciosPrincipalesFijos, request);
    };
