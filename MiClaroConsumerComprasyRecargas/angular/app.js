...
miClaroApp.config(['$routeProvider', function($routeProvider,$location){
        ...
        $routeProvider.when('/', {templateUrl: 'angular/view/consumer-compras-recargas.html', controller: 'ControllerComprasyRecargas', controllerAs:'miClaroComprasyRecargasCtr'});
        $routeProvider.when('/confirmacionCompra', {templateUrl: 'angular/view/consumer-compras-recargas-confirmacion.html', controller: 'ControllerComprasyRecargasExito', controllerAs:'miClaroComprasyRecargasExitoCtr'});	
