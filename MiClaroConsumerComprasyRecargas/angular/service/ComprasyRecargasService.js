...
$http.defaults.headers.post = {'Access-Control-Allow-Origin':undefined};  
	...
	this.actualizarClaroPuntosSesion = function(){
		return $http.get(urlActualizarClaroPuntos);
	};
	
	this.obtenerEstadoServicio = function(request){
	var requestFormat = $httpParamSerializer({ requestJson: angular.toJson(request) });
		return $http.post(comprasyRecargasUrl.obtenerEstadoServicio,requestFormat);
	};
