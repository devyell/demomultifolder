...
appController.controller('ctrlNuevoServicioFijo', ['$scope', '$http', '$timeout', 'srvNuevoServicioFijo', '$httpParamSerializer',
    function($scope, $http, $timeout, srvNuevoServicioFijo, $httpParamSerializer) {
        ...
        var pageIdNuevoServicio = WPSPageID.miclaro_corporativo_solicitudes_nuevoservicio_fijo;
        ...
        var tipoLineaCorporativo = WPSTipoLinea.postpago;
        ...
        $scope.urlInicio = '/wps/myportal/miclaro/corporativo/solicitudes/nuevoservicio/fijo';
        ...
        function init() {
            srvNuevoServicioFijo.obtenerDatosUsuario().then(function(response) {
        ...
        $scope.solicitarNuevoServicio = function() {
            ...
            srvNuevoServicioFijo.solicitarNuevoServicios(dataPlan).then(function(response) {
        ...
        function guardarAuditoria(rpta, idTransaccion,mensajeAuditoria) {
            ...
            srvNuevoServicioFijo.guardarAuditoria(dataAuditoria).then(function(response) {}, function(error) {
