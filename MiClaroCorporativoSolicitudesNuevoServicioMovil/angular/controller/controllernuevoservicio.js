...
appController.controller('ctrlNuevoServicioMovil', ['$scope', '$http', '$timeout', 'srvNuevoServicioMovil', '$httpParamSerializer',
    function($scope, $http, $timeout, srvNuevoServicioMovil, $httpParamSerializer) {
        ...
        var pageIdNuevoServicio = WPSPageID.miclaro_corporativo_solicitudes_nuevoservicio_movil;
        ...
        $scope.urlInicio = '/wps/myportal/miclaro/corporativo/solicitudes/nuevoservicio/movil';
        var nombreLinea = '-';
        ...
        function init() {
            srvNuevoServicioMovil.obtenerDatosUsuario().then(function(response) {
        ...
        $scope.solicitarNuevoServicio = function() {
            ...
            srvNuevoServicioMovil.solicitarNuevoServicios(dataPlan).then(function(response) {
        ...
        function guardarAuditoria(rpta, idTransaccion, mensajeAuditoria) {
            ...
            srvNuevoServicioMovil.guardarAuditoria(dataAuditoria).then(function(response) {}, function(error) {
