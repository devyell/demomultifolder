    ...
    modService.getObtenerDatosSesion().then(function(response) {
    	...
    	tipoCliente = response.data.comunResponseType.tipoClienteProductoPrincipal;
		    if (categoriaPrincipal == 1){
		    	window.location.replace("/wps/myportal/miclaro/corporativo/consultas/historialtransacciones/movil/");
		    } else if (categoriaPrincipal == 2){
		    	window.location.replace("/wps/myportal/miclaro/corporativo/consultas/historialtransacciones/fijo/");
		    } else if (categoriaPrincipal == 3){
		    	window.location.replace("/wps/myportal/miclaro/corporativo/consultas/historialtransacciones/internet/");
		    } else if (categoriaPrincipal == 4){
		    	window.location.replace("/wps/myportal/miclaro/corporativo/consultas/historialtransacciones/tv/");
		    }
