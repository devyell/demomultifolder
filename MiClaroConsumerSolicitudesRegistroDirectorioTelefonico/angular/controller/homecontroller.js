    ...
    srvDirectorioHome.getObtenerDatosSesion().then(function(response) {
    	...
    	tipoCliente = response.data.comunResponseType.tipoClienteProductoPrincipal; 	
		    ...
		    if (categoriaPrincipal == 1){
		    	window.location.replace("/wps/myportal/miclaro/consumer/solicitudes/registrodirectoriotelefonico/movil");
		    } else if (categoriaPrincipal == 2){
		    	window.location.replace("/wps/myportal/miclaro/consumer/solicitudes/registrodirectoriotelefonico/fijo");
		    } else if (categoriaPrincipal == 3){
		    	window.location.replace("/wps/myportal/miclaro/consumer/solicitudes/registrodirectoriotelefonico/internet");
		    } else if (categoriaPrincipal == 4){
		    	window.location.replace("/wps/myportal/miclaro/consumer/solicitudes/registrodirectoriotelefonico/tv");
		    }
