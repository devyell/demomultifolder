    ...
    serviceHome.getObtenerDatosSesion().then(function(response) {
    	...
    	tipoCliente = response.data.comunResponseType.tipoClienteProductoPrincipal; 	
		    ...
		    if (categoriaPrincipal == 1){
		    	...
		    	window.location.replace("/wps/myportal/miclaro/consumer/consultas/detalleconsumos/movil");
		    	...
		    	window.location.replace("/wps/myportal/miclaro/consumer/consultas/detalleconsumos/internet");
		    } else if (categoriaPrincipal == 4){

		    	window.location.replace("/wps/myportal/miclaro/consumer/consultas/detalleconsumos/tv");
		    }else {
				window.location.replace("/wps/myportal/miclaro/consumer/consultas/detalleconsumos/movil");
			}
