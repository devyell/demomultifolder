app.controller("RecibosTvController", function($scope, $timeout, $location, $httpParamSerializer, recibosTvService, FileSaver, Blob, $sessionStorage) {
    ...
    var pageIdRecibosCorporativo = WPSPageID.miclaro_corporativo_recibos_tv;
        ...
        recibosTvService.obtenerServicioPrincipal().then(function(response) {
            ...
            if (rpta == 0) {
                ...
                if (categoriaPrincipal == "4" && tipoClientePrincipal == "2") {
                    $scope.recibosTvCtr.idDireccionPrincipal = response.data.comunResponseType.idDireccion;
                    $scope.recibosTvCtr.idProductoPrincial = response.data.comunResponseType.productoPrincipal;

                } else {
                    $scope.recibosTvCtr.idDireccionPrincipal = null;
                    $scope.recibosTvCtr.idProductoPrincial = null;
                }

                $scope.recibosTvCtr.obtenerDireccionesFijos();
    ...
    this.obtenerDireccionesFijos = function() {
        ...
        var requestDireccion = {
            "tipoCliente": WPSTipoClienteDir.corporativoTv
        };
        var dataDireccion = $httpParamSerializer({ requestJson: angular.toJson(requestDireccion) });

        recibosTvService.obtenerListadoFijoDireccion(dataDireccion).then(function(response) {
            ...
            if (rpta == 0) {
                ...
                $scope.recibosTvCtr.direccionesFijasList = [];

                if (angular.isArray(dataDireccionesList)) {
                    $scope.recibosTvCtr.direccionesFijasList = dataDireccionesList;
                } else {
                    $scope.recibosTvCtr.direccionesFijasList.push(dataDireccionesList);
                }

                if ($scope.recibosTvCtr.idDireccionPrincipal != null) {
                    angular.forEach($scope.recibosTvCtr.direccionesFijasList, function(val, key) {
                        if (val.idDireccion === $scope.recibosTvCtr.idDireccionPrincipal) {
                            $scope.recibosTvCtr.direccion = $scope.recibosTvCtr.direccionesFijasList[key];
                            $scope.mostraDireccion = $scope.recibosTvCtr.direccionesFijasList[key].aliasDireccion;
                            servicioParam = $scope.recibosTvCtr.direccionesFijasList[key].idDireccion;
                        }
                    });
                } else {
                    $scope.recibosTvCtr.direccion = $scope.recibosTvCtr.direccionesFijasList[0];
                    $scope.mostraDireccion = $scope.recibosTvCtr.direccionesFijasList[0].aliasDireccion;
                    servicioParam = $scope.recibosTvCtr.direccionesFijasList[0].idDireccion;
                }

                $scope.recibosTvCtr.obtenerServiciosPrincipalesFijos();
    ...
    this.obtenerServiciosPrincipalesFijos = function() {
        ...
        var requestObtenerServiciosPrincipalesFijos = {
            idDireccion: $scope.recibosTvCtr.direccion.idDireccion,
        ...
        recibosTvService.obtenerServiciosPrincipalesFijos(dataObtenerServiciosPrincipalesFijos).then(function(response) {
            ...
            if (rpta == 0) {
                ...
                $scope.recibosTvCtr.serviciosFijosPrincipalesList = [];
                ...
                if (angular.isArray(dataLineaList)) {
                    $scope.recibosTvCtr.serviciosFijosPrincipalesList = dataLineaList;
                } else {
                    $scope.recibosTvCtr.serviciosFijosPrincipalesList.push(dataLineaList);
                }

                $scope.recibosTvCtr.servicioInternetPrincipal = $scope.recibosTvCtr.serviciosFijosPrincipalesList[0];
    ...
    this.obtenerLineas = function() {
        ...
        var requestObtenerServicios = {
            ...
            idCuenta: null,
            idRecibo: $scope.recibosTvCtr.servicioInternetPrincipal.idServicioPrincipalFijo,
            idDireccion: $scope.recibosTvCtr.direccion.idDireccion,
            nombreProducto: null,
            pagina: 0,
        ...
        recibosTvService.getObtenerServicios(dataObtenerServicios).then(function(response) {
            ...
            if (rpta == 0) {
                ...
                if (dataLineaList != undefined && dataLineaList != '') {
                    ...
                    $scope.lineaCorporativaMostrar = $scope.recibosTvCtr.lineasCorporativoList[0].ProductoServicioResponse.nombreAlias;
                    permisoAuditoria = $scope.recibosTvCtr.lineasCorporativoList[0].ProductoServicioResponse.tipoPermiso;
    ...
    function buscarDatosAdicionales() {
        ...
        datosAdicionalesRequest.idDireccion = $scope.recibosTvCtr.direccion.idDireccion;
    ...
    this.buscarDatosRecibo = function() {
        ...
        var requestObtenerDeudaPendiente = {
            ...
            idRecibo: $scope.recibosTvCtr.servicioInternetPrincipal.idServicioPrincipalFijo,
            idDireccion: $scope.recibosTvCtr.direccion.idDireccion,
            idProductoServicio: $scope.recibosTvCtr.servicioInternetPrincipal.idProductoServicio
    ...
    this.pagarRecibosSeleccionados = function() {
        ...
        for (var i = 0; i < $scope.recibosTvCtr.recibosSeleccionadosList.length; i++) {
            var objSelec = {
                ...
                name: 'Recibo internet - ' + $scope.recibosTvCtr.recibosSeleccionadosList[i].mesRecibo,
    ...
    function registrarInicioTransaccionPagoTC(idDireccion, idServicioPrincipalFijo, importePago, idCategoriaDeCompra, idProductoDeCompra, listaRecibos) {
        ...
        var requestRegistrarInicioTransaccionPagoTC = {
            tipoTransaccion: "1",
            categoria: WPSCategoria.tv,
            tipoCliente: $scope.recibosTvCtr.tipoClienteSession,
            idCuenta: $scope.recibosTvCtr.linea.ProductoServicioResponse.idCuenta,
            idRecibo: $scope.recibosTvCtr.linea.ProductoServicioResponse.idRecibo,
