...
app.config(function($routeProvider){
	...
	$routeProvider.when('/', {templateUrl: 'angular/view/consumer-recibos.html', controller: 'RecibosFijoController',controllerAs: 'recibosFijoCtr'});
	...
	$routeProvider.when('/confirmacionErrorPagoPasarelaView', {templateUrl: 'angular/view/consumer-recibos-confirmacion-error-pasarela.html', controller: 'RecibosFijoController',controllerAs: 'recibosFijoCtr'});
	...
	$routeProvider.when('/usuarioPrepagoView', {templateUrl: 'angular/view/usuarioPrepago.html', controller: 'RecibosFijoController',controllerAs: 'recibosFijoCtr'});
...
angular.element(document).ready(function() {
    angular.bootstrap(document.getElementById("recibosFijo"),['miClaroApp']);
});